...
const nav: { href: string; label: string; capability: Parameters<typeof can>[1] }[] = [
  ...
  { href: "/erp/scoreboard", label: "Scoreboard", capability: "scoreboard" },
  { href: "/erp/analytics", label: "Analytics", capability: "analytics" },
  { href: "/erp/alerts", label: "Alerts", capability: "alerts" },
  ...
  { href: "/erp/forecast", label: "Forecast", capability: "forecast" },
  { href: "/erp/purchases", label: "Purchases / GRN", capability: "purchases" },
  { href: "/erp/suppliers", label: "Suppliers", capability: "suppliers" },
  ...
  { href: "/erp/staff", label: "Staff", capability: "attendance" },
  { href: "/erp/payroll", label: "Payroll", capability: "payroll" },
  { href: "/erp/handover", label: "Handover", capability: "handover" },
  { href: "/erp/delivery", label: "Delivery", capability: "delivery" },
  { href: "/erp/quality", label: "Food Safety", capability: "quality" },
  { href: "/erp/mobile", label: "Mobile API", capability: "mobileApi" },
  { href: "/erp/accounting", label: "Accounting", capability: "accounting" },
  { href: "/erp/wastage", label: "Wastage", capability: "wastage" },
  { href: "/erp/exports", label: "Export packs", capability: "exports" },
